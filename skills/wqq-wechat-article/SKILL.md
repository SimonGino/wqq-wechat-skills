...
微信公众号对敏感词审核严格，文章被删无法恢复。**标题和正文都必须过合规检查。**
...
**执行规则：**
1. 标题是重点审核对象 — 标题里绝对不放高危词
2. 正文中如果必须提及某个平台/工具，用泛化描述或英文缩写降低命中率
3. 组合放大风险 — "信息收集 + Telegram"比单独任一个都危险得多，避免敏感词叠加
4. 拿不准时宁可模糊，文章活着比精确重要
